...
<form action="/eje2/resultado2.php" method="POST" target="resultado">
    ...
    <div class="field is-horizontal">
        ...
        <div class="field-body">
            <div class="field">
            <p class="control">
                <input class="input" type="text" placeholder="Escribe la edad de la persona" name="nombre" />
            </p>
            </div>
        </div>
    </div>
...
<script>
    ...
    window.onload = function(){
        ...
        page.style.background = "url('https://media.newyorker.com/photos/5f85dfc828c87358b3ee98ea/master/w_1920,c_limit/Aarons-MiddleAgeRevealParty.jpg')";
