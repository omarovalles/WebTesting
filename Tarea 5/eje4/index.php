...
<form action="/eje4/resultado4.php" method="POST" target="resultado">
    ...
    <div class="field is-horizontal">
        ...
        <div class="field-body">
            <div class="field">
            <p class="control">
                <input class="input" type="text" placeholder="Escribe el pais" name="nombre" />
            </p>
            </div>
        </div>
    </div>
...
<script>
    ...
    window.onload = function(){
        ...
        page.style.background = "url('https://cdn0.uncomo.com/es/posts/7/1/6/cuantos_paises_hay_en_el_mundo_29617_600.webp')";
